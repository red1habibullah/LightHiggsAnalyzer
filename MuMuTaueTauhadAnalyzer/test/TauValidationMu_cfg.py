...
process.ValidateTauM= cms.EDAnalyzer("TauValidationAnalyzer",
                                    #Taus=cms.InputTag("slimmedTaus"),
                                     #Taus=cms.InputTag("selectedPatTausElectronCleaned"),                                                                                                                                                                                      
                                    #Taus=cms.InputTag("slimmedTausElectronCleaned"),                                                                                                                                                                                          
                                    Taus=cms.InputTag("slimmedTausMuonCleaned"),                                                                                                                                                                                              
...
process.ValidateTauE= cms.EDAnalyzer("TauValidationAnalyzer",
                                    #Taus=cms.InputTag("slimmedTaus"),
                                    #Taus=cms.InputTag("selectedPatTausElectronCleaned"),                                                                                                                                                                                      
                                    Taus=cms.InputTag("slimmedTausElectronCleaned"),                                                                                                                                                                                          
                                    #Taus=cms.InputTag("slimmedTausMuonCleaned"),                                                                                                                                                                                              
...
process.ValidateTauB= cms.EDAnalyzer("TauValidationAnalyzer",
                                    #Taus=cms.InputTag("slimmedTaus"),                                                                                                                                                                                                         
                                    #Taus=cms.InputTag("selectedPatTausElectronCleaned"),                                                                                                                                                                                     \
                                                                                                                                                                                                                                                                               
                                    Taus=cms.InputTag("slimmedTausBoosted"),
                                    #Taus=cms.InputTag("slimmedTausMuonCleaned"),                                                                                                                                                                                             \
...
process.source = cms.Source("PoolSource", 
                            ...
                            fileNames = cms.untracked.vstring('file:mumutautau_LowBoostNoIso_numEvent5000.root')
                            ...
                            #fileNames = cms.untracked.vstring('file:mumutautau_MuonCleanIso_cout_numEvent5000.root')
                            #fileNames = cms.untracked.vstring('file:mumutautau_MuonCleanIso_shift_numEvent5000.root')
                            #fileNames = cms.untracked.vstring('file:mumutautau_MuonCleanIso_Maptest_numEvent5000.root')  
                            #fileNames = cms.untracked.vstring('file:mumutautau_MuonCleanIso_pfCandTest_AddJets_numEvent5000.root') 
                            #fileNames = cms.untracked.vstring('file:mumutautau_MuonCleanIso_RepfCandTest_AddJets_numEvent5000.root')
                            )
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('file:test_LowBoostNoIso.root')
                                   )
...
process.p = cms.Path(process.DiMuFilter*process.ValidateTau*process.ValidateTauE*process.ValidateTauM*process.ValidateTauB)
