...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName = cms.string('file:ElectronEfficiency_mA20.root')
                                   )
...
process.p_l = cms.Path(process.GenModeFilter*process.DiMuFilter*process.LooseFilter*process.EleEffLoose);
process.p_m = cms.Path(process.GenModeFilter*process.DiMuFilter*process.MediumFilter*process.EleEffMedium);
process.p_t = cms.Path(process.GenModeFilter*process.DiMuFilter*process.TightFilter*process.EleEffTight);
process.schedule=cms.Schedule(process.p_l,process.p_m,process.p_t)

# process.p_l = cms.Path(process.GenModeFilter*process.DiMuFilter*process.LooseFilter*process.TauEffDModeLoose*process.TauEffEDModeLoose)
# process.p_m = cms.Path(process.GenModeFilter*process.DiMuFilter*process.MediumFilter*process.TauEffDModeMedium*process.TauEffEDModeMedium)
# process.p_t = cms.Path(process.GenModeFilter*process.DiMuFilter*process.TightFilter*process.TauEffDModeTight*process.TauEffEDModeTight)
# process.schedule=cms.Schedule(process.p_l,process.p_m,process.p_t)
