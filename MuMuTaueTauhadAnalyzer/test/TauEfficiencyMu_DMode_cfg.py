...
process.source = cms.Source("PoolSource", 
                            ...
                            fileNames = cms.untracked.vstring(# 'file:/eos/uscms/store/user/rhabibul/SUSYGluGluToHToAA_AToMuMu_AToTauTau_M-125_M-5_TuneCUETP8M1_13TeV_madgraph_pythia8/MiniAOD_H125AA05_DiMuDiTau_Fall17DRPremix_v1/191028_182143/0000/mumutautau_FinaltesOBt_1.root','file:/eos/uscms/store/user/rhabibul/SUSYGluGluToHToAA_AToMuMu_AToTauTau_M-125_M-5_TuneCUETP8M1_13TeV_madgraph_pythia8/MiniAOD_H125AA05_DiMuDiTau_Fall17DRPremix_v1/191028_182143/0000/mumutautau_FinaltesOBt_2.root',
...
process.TauEffDMode =cms.EDAnalyzer("TauEfficiencyMu",
                                    Taus=cms.InputTag("slimmedTaus"),
                                    pruned  = cms.InputTag("prunedGenParticles"),
...
process.TauEffMDMode =cms.EDAnalyzer("TauEfficiencyMu",
                                     Taus=cms.InputTag("slimmedTausMuonCleaned"),
                                     pruned  = cms.InputTag("prunedGenParticles"),
                                     muonSrc =cms.InputTag("ThirdMuFilter","ThirdMuon","complete"),
...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName = cms.string('file:TauEffDModeMClean_mA9_DMode_Jet_Cleaned_dRTest_Total_Lep.root')
                                   )
...
#process.p = cms.Path(process.GenModeFilterMu*process.DiMuFilter*process.ThirdMu*process.TauEffDMode*process.TauEffMDMode)
process.p = cms.Path(process.GenModeFilterMu*process.DiMuFilter*process.ThirdMuFilter*process.TauEffDMode*process.TauEffMDMode)
