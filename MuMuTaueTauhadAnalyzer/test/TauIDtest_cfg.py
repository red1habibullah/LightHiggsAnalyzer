...
process.ElectronLoose=cms.EDAnalyzer("TauIDTester",
                                 Taus=cms.InputTag("slimmedTausElectronCleaned"),
                                 ObjectID=cms.InputTag("ak4PFJetsElectronCleaned","ElectronsPassingID"),
                                 ObjectRemoved=cms.InputTag("ak4PFJetsElectronCleaned","ElectronsRemoved"),
                                 JetCleaned=cms.InputTag("ak4PFJetsElectronCleaned","NumJetsElectronsCleaned"),
)

process.ElectronMedium=cms.EDAnalyzer("TauIDTester",
                                 Taus=cms.InputTag("slimmedTausElectronCleanedMedium"),
                                 ObjectID=cms.InputTag("ak4PFJetsElectronCleanedMedium","ElectronsPassingID"),
                                 ObjectRemoved=cms.InputTag("ak4PFJetsElectronCleanedMedium","ElectronsRemoved"),
                                 JetCleaned=cms.InputTag("ak4PFJetsElectronCleanedMedium","NumJetsElectronsCleaned"),
)
process.ElectronTight=cms.EDAnalyzer("TauIDTester",
                                 Taus=cms.InputTag("slimmedTausElectronCleanedTight"),
                                 ObjectID=cms.InputTag("ak4PFJetsElectronCleanedTight","ElectronsPassingID"),
                                 ObjectRemoved=cms.InputTag("ak4PFJetsElectronCleanedTight","ElectronsRemoved"),
                                 JetCleaned=cms.InputTag("ak4PFJetsElectronCleanedTight","NumJetsElectronsCleaned"),
)
...
#########################################################################
process.Rerun= cms.EDAnalyzer("TauRerunTester",
                                    #Taus=cms.InputTag("slimmedTaus"),
                                    Taus=cms.InputTag("slimmedTausElectronCleaned"),
                                    #Taus=cms.InputTag("slimmedTaus"),
                                    TausUnCleaned=cms.InputTag("slimmedTausElectronCleanedMedium"),
...
process.source = cms.Source("PoolSource", 
                                fileNames = cms.untracked.vstring('file:mumutautau_MultipleID_test_numEvent1000.root') 
...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName = cms.string('file:TauIDValidation_test.root')
                                   )




process.p = cms.Path(process.MuonLoose*process.MuonMedium*process.MuonTight*process.ElectronLoose*process.ElectronMedium*process.ElectronTight)
